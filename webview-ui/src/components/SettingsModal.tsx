  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={() => {
            appBridge.postMessage({ type: 'openSessionsFolder' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            appBridge.postMessage({ type: 'exportLayout' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            appBridge.postMessage({ type: 'importLayout' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            ...
            appBridge.postMessage({ type: 'setSoundEnabled', enabled: newVal })
          }}
